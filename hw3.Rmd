...
Please turn in your write-up from the Topic 10: [Applied Analysis: Regression](applied-analysis-regression.html).

<br>

## Primary objectives {-}

The following learning objectives are the primary focus of this assignment and are already captured in the [Applied Analysis: Regression](applied-analysis-regression.html) activity:
