...
- Causal Discovery: [[video]](https://youtu.be/buPv9AsyGZY), [[slides]](https://drive.google.com/file/d/1hMlOH66vA1t9x7YLEm1DPJV5WJ-5FKmM/view?usp=sharing)

[Checkpoint](https://moodle.macalester.edu/mod/quiz/view.php?id=33010)
...
**You can download a template RMarkdown file to start from [here](template_rmds/15-causal-discovery.Rmd).**
...
Although you may not choose to do a data analysis for the final project, write a short plan for a set of sensitivity analyses you could conduct to enrich your causal analysis. What sensitivity analyses would you conduct, and how would you present and communicate the results?
